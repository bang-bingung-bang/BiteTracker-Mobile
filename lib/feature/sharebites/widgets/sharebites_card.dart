...
class _ShareBitesCardState extends State<ShareBitesCard> {
  ...
  Future<void> fetchLikeStatus() async {
    ...
    try {
      final response = await request.get(
        'http://localhost:8000/sharebites/post/${widget.post.pk}/like-status/?user_id=${widget.currentUserId}',
      );
  ...
  Future<void> toggleLike() async {
    ...
    try {
      final response = await request.postJson(
        'http://localhost:8000/sharebites/post/${widget.post.pk}/like-toggle/',
        jsonEncode({
  ...
  Future<void> fetchComments() async {
    ...
    try {
      final response = await request.get(
        'http://localhost:8000/sharebites/post/${widget.post.pk}/comments/get/',
      );
  ...
  Future<void> addComment() async {
    ...
    try {
      final response = await request.postJson(
        'http://localhost:8000/sharebites/post/${widget.post.pk}/comments/add/',
        jsonEncode({
